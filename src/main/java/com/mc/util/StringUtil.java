...
public class StringUtil {
	...
	//方法1：判断源字符串是否有值，空引号(空白字符串)也算没值 (5分)
		...
		//方法2：判断源字符串，输入空引号和空格也算没有值
		public static boolean hasText(String src){	
			return src!=null && src.trim().length()>0;//String 的trim()方法 去掉字符串里面的空格
		}
		
		
		//方法3-1返回一个中文汉字字符串 字符集必须在GB2312(相当于中文简体)范围内，
		public static String randomChinese() {
			 String str = null;
	         int highPos, lowPos;
	         Random random = new Random();
	         highPos = (176 + Math.abs(random.nextInt(30)));//区码，0xA0打头，从第16区开始，即0xB0=11*16=176,16~55一级汉字，56~87二级汉字
	         random=new Random();
		...
		//方法3-2：返回长度为length的中文汉字字符串，字符集必须在GB2312(相当于中文简体)范围内，例如“中呀被”(5分)
		...
		//方法6 判断是否是邮箱 字母数字下划线开头@字母数字下划线.字母数字  ssss@sdfsd.com
